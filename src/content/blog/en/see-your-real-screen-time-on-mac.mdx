...
- **Focus, Neutral, Personal or Distraction**: every app is categorized, so instead of a flat list of hours you get a [Focus Score](/guide/focus-score) — a single number for how much of your active time was real work.
